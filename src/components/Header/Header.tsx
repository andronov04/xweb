...
function Header() {
  ...
  return (
    <>
      {open ? (
        <div className="fixed z-50 top-0 left-0 flex justify-center py-5 items-center bg-black h-auto w-full">
      ...
      <div className="md:hidden flex justify-between items-center">
        ...
        <button
          ...
          className="ml-2 inline-flex items-center justify-center p-2 text-white"
          aria-expanded="false"
        >
